  ...
  return (
    <div className="flex-container">
      <div className="header-content">
        <h3 className="head-bold">Register in the month of September and receive a special gift!</h3>
      </div>
      ...
      <div className="main-content">
        <div className="inner-content">
          ...
          <p className="center">Your dog was successfully registered!</p>
              <div className="link-container">
                <Link to="/register">
                    <button className="link-btn center">Register Another Dog</button>  
                </Link>  
                <Link to="/reg-dogs">
